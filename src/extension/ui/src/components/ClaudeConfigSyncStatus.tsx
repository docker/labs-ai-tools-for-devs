...
export const ClaudeConfigSyncStatus = ({ client }: { client: v1.DockerDesktopClient }) => {
    ...
    return <Badge badgeContent={status.state} color={status.color} sx={{ ml: 1 }}>
        <div style={{ width: 150, height: 'auto', cursor: 'pointer' }} onClick={() => { setShowConfigModal(!showConfigModal) }}>
