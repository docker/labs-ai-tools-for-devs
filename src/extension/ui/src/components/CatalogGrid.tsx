    ...
    return (
        <Stack spacing={2} justifyContent='center' alignItems='center'>
            ...
            <Box sx={{ position: 'sticky', top: 0, zIndex: 1000, backgroundColor: 'background.default' }}>
                ...
                {
                    tab === 0 && <Stack direction="row" spacing={1} alignItems='center' sx={{ mt: 1, py: 1, width: '90vw', maxWidth: '1000px' }}>
                        <FormGroup>
                            <Stack direction="row" spacing={1} alignItems='center' justifyContent="space-evenly">
                                <TextField label="Search" sx={{ width: 333 }} value={search} onChange={(e) => setSearch(e.target.value)} />
                                <IconButton
